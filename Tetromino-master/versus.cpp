...
versus::versus(QWidget *parent)
{
    ...
    w_Label = new QLabel(tr("<font color = white>W-ROTATE</font>"));
    a_Label = new QLabel(tr("<font color = white>S-DOWN</font>"));
    s_Label = new QLabel(tr("<font color = white>A-LEFT</font>"));
    d_Label = new QLabel(tr("<font color = white>D-RIGHT</font>"));
    up_Label = new QLabel(tr("<font color = white>↑-ROTATE</font>"));
    down_Label = new QLabel(tr("<font color = white>↓-DOWN</font>"));
    left_Label = new QLabel(tr("<font color = white>←-LEFT</font>"));
    right_Label = new QLabel(tr("<font color = white>→-RIGHT</font>"));
    spaceLabel = new QLabel(tr("<font color = white>SPACE-SKIP</font>"));
    backspaceLabel = new QLabel(tr("<font color = white>BACKSPACE-SKIP</font>"));
    ...
    scoreTitleLabel = new QLabel(tr("<font color = white>P1 SCORE：</font>"));
    scoreLabel = new QLabel(tr("<font color = white>0</font>"));
    scoreTitleLabel4p2 = new QLabel(tr("<font color = white>P2 SCORE：</font>"));
    scoreLabel4p2 = new QLabel(tr("<font color = white>0</font>"));
    diffTitleLabel = new QLabel(tr("<font color = white>P1 DIFFICULTY:</font>"));
    diffLabel = new QLabel(tr("<font color = white>0</font>"));
    diffTitleLabel4p2 = new QLabel(tr("<font color = white>P2 DIFFICULTY:</font>"));
